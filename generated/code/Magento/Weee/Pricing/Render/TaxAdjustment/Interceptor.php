...
class Interceptor extends \Magento\Weee\Pricing\Render\TaxAdjustment implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDefaultExclusions');
        return $pluginInfo ? $this->___callPlugins('getDefaultExclusions', func_get_args(), $pluginInfo) : parent::getDefaultExclusions();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDisplayAmountExclTax');
        return $pluginInfo ? $this->___callPlugins('getDisplayAmountExclTax', func_get_args(), $pluginInfo) : parent::getDisplayAmountExclTax($exclude, $includeContainer);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRawAmount');
        return $pluginInfo ? $this->___callPlugins('getRawAmount', func_get_args(), $pluginInfo) : parent::getRawAmount($exclude);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDisplayAmount');
        return $pluginInfo ? $this->___callPlugins('getDisplayAmount', func_get_args(), $pluginInfo) : parent::getDisplayAmount($includeContainer);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'buildIdWithPrefix');
        return $pluginInfo ? $this->___callPlugins('buildIdWithPrefix', func_get_args(), $pluginInfo) : parent::buildIdWithPrefix($prefix);
    }
    ...
    public function displayPriceIncludingTax()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('displayPriceIncludingTax', func_get_args(), $pluginInfo) : parent::displayPriceIncludingTax();
    }
    ...
    public function displayPriceExcludingTax()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('displayPriceExcludingTax', func_get_args(), $pluginInfo) : parent::displayPriceExcludingTax();
    }
