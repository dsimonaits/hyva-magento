...
class Interceptor extends \Magento\Weee\Pricing\Render\Adjustment implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRawFinalAmount');
        return $pluginInfo ? $this->___callPlugins('getRawFinalAmount', func_get_args(), $pluginInfo) : parent::getRawFinalAmount();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAdjustmentCode');
        return $pluginInfo ? $this->___callPlugins('getAdjustmentCode', func_get_args(), $pluginInfo) : parent::getAdjustmentCode();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFinalAmount');
        return $pluginInfo ? $this->___callPlugins('getFinalAmount', func_get_args(), $pluginInfo) : parent::getFinalAmount();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'showInclDescr');
        return $pluginInfo ? $this->___callPlugins('showInclDescr', func_get_args(), $pluginInfo) : parent::showInclDescr();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'showExclDescrIncl');
        return $pluginInfo ? $this->___callPlugins('showExclDescrIncl', func_get_args(), $pluginInfo) : parent::showExclDescrIncl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWeeeTaxAttributes');
        return $pluginInfo ? $this->___callPlugins('getWeeeTaxAttributes', func_get_args(), $pluginInfo) : parent::getWeeeTaxAttributes();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderWeeeTaxAttributeName');
        return $pluginInfo ? $this->___callPlugins('renderWeeeTaxAttributeName', func_get_args(), $pluginInfo) : parent::renderWeeeTaxAttributeName($attribute);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderWeeeTaxAttribute');
        return $pluginInfo ? $this->___callPlugins('renderWeeeTaxAttribute', func_get_args(), $pluginInfo) : parent::renderWeeeTaxAttribute($attribute);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderWeeeTaxAttributeWithTax');
        return $pluginInfo ? $this->___callPlugins('renderWeeeTaxAttributeWithTax', func_get_args(), $pluginInfo) : parent::renderWeeeTaxAttributeWithTax($attribute);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderWeeeTaxAttributeWithoutTax');
        return $pluginInfo ? $this->___callPlugins('renderWeeeTaxAttributeWithoutTax', func_get_args(), $pluginInfo) : parent::renderWeeeTaxAttributeWithoutTax($attribute);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTaxDisplayConfig');
        return $pluginInfo ? $this->___callPlugins('getTaxDisplayConfig', func_get_args(), $pluginInfo) : parent::getTaxDisplayConfig();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isPriceIncludesTax');
        return $pluginInfo ? $this->___callPlugins('isPriceIncludesTax', func_get_args(), $pluginInfo) : parent::isPriceIncludesTax();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAmountRender');
        return $pluginInfo ? $this->___callPlugins('getAmountRender', func_get_args(), $pluginInfo) : parent::getAmountRender();
    }
     ...
     * {@inheritdoc}
     */
    public function convertAndFormatCurrency($amount, $includeContainer = true, $precision = 2)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'convertAndFormatCurrency');
        return $pluginInfo ? $this->___callPlugins('convertAndFormatCurrency', func_get_args(), $pluginInfo) : parent::convertAndFormatCurrency($amount, $includeContainer, $precision);
    }
    ...
    public function getAdjustment()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getAdjustment', func_get_args(), $pluginInfo) : parent::getAdjustment();
    }
