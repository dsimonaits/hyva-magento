...
class Interceptor extends \Magento\Backend\Block\Dashboard\Sales implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addTotal($label, $value, $isQuantity = false)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addTotal', func_get_args(), $pluginInfo) : parent::addTotal($label, $value, $isQuantity);
    }
    ...
    public function format($price)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('format', func_get_args(), $pluginInfo) : parent::format($price);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDataHelper');
        return $pluginInfo ? $this->___callPlugins('getDataHelper', func_get_args(), $pluginInfo) : parent::getDataHelper();
    }
