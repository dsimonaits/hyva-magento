...
class Interceptor extends \Magento\Backend\Block\Widget\Grid\Column\Filter\Range implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getValue($index = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getValue', func_get_args(), $pluginInfo) : parent::getValue($index);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCondition');
        return $pluginInfo ? $this->___callPlugins('getCondition', func_get_args(), $pluginInfo) : parent::getCondition();
    }
