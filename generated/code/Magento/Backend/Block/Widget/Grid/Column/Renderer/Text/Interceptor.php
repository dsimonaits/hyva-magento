...
class Interceptor extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\Text implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getValue');
        return $pluginInfo ? $this->___callPlugins('_getValue', func_get_args(), $pluginInfo) : parent::_getValue($row);
    }
