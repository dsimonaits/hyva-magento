...
class Interceptor extends \Magento\Captcha\Block\Adminhtml\Captcha\DefaultCaptcha implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRefreshUrl');
        return $pluginInfo ? $this->___callPlugins('getRefreshUrl', func_get_args(), $pluginInfo) : parent::getRefreshUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCaptchaModel');
        return $pluginInfo ? $this->___callPlugins('getCaptchaModel', func_get_args(), $pluginInfo) : parent::getCaptchaModel();
    }
