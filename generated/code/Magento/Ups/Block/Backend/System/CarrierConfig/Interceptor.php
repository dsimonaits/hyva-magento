...
class Interceptor extends \Magento\Ups\Block\Backend\System\CarrierConfig implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCarrierConfig');
        return $pluginInfo ? $this->___callPlugins('getCarrierConfig', func_get_args(), $pluginInfo) : parent::getCarrierConfig();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWebsiteModel');
        return $pluginInfo ? $this->___callPlugins('getWebsiteModel', func_get_args(), $pluginInfo) : parent::getWebsiteModel();
    }
    ...
    public function getConfig($path, $store = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getConfig', func_get_args(), $pluginInfo) : parent::getConfig($path, $store);
    }
