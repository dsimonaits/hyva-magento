...
class Interceptor extends \Magento\Customer\Block\Adminhtml\System\Config\Validatevat implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setMerchantCountryField');
        return $pluginInfo ? $this->___callPlugins('setMerchantCountryField', func_get_args(), $pluginInfo) : parent::setMerchantCountryField($countryField);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMerchantCountryField');
        return $pluginInfo ? $this->___callPlugins('getMerchantCountryField', func_get_args(), $pluginInfo) : parent::getMerchantCountryField();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setMerchantVatNumberField');
        return $pluginInfo ? $this->___callPlugins('setMerchantVatNumberField', func_get_args(), $pluginInfo) : parent::setMerchantVatNumberField($vatNumberField);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMerchantVatNumberField');
        return $pluginInfo ? $this->___callPlugins('getMerchantVatNumberField', func_get_args(), $pluginInfo) : parent::getMerchantVatNumberField();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setVatButtonLabel');
        return $pluginInfo ? $this->___callPlugins('setVatButtonLabel', func_get_args(), $pluginInfo) : parent::setVatButtonLabel($vatButtonLabel);
    }
