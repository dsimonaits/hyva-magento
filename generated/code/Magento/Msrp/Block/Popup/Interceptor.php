...
class Interceptor extends \Magento\Msrp\Block\Popup implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getExplanationMessage');
        return $pluginInfo ? $this->___callPlugins('getExplanationMessage', func_get_args(), $pluginInfo) : parent::getExplanationMessage();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getExplanationMessageWhatsThis');
        return $pluginInfo ? $this->___callPlugins('getExplanationMessageWhatsThis', func_get_args(), $pluginInfo) : parent::getExplanationMessageWhatsThis();
    }
