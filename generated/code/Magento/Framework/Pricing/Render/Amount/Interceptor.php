...
class Interceptor extends \Magento\Framework\Pricing\Render\Amount implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setDisplayValue');
        return $pluginInfo ? $this->___callPlugins('setDisplayValue', func_get_args(), $pluginInfo) : parent::setDisplayValue($value);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDisplayValue');
        return $pluginInfo ? $this->___callPlugins('getDisplayValue', func_get_args(), $pluginInfo) : parent::getDisplayValue();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDisplayCurrencyCode');
        return $pluginInfo ? $this->___callPlugins('getDisplayCurrencyCode', func_get_args(), $pluginInfo) : parent::getDisplayCurrencyCode();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDisplayCurrencySymbol');
        return $pluginInfo ? $this->___callPlugins('getDisplayCurrencySymbol', func_get_args(), $pluginInfo) : parent::getDisplayCurrencySymbol();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasAdjustmentsHtml');
        return $pluginInfo ? $this->___callPlugins('hasAdjustmentsHtml', func_get_args(), $pluginInfo) : parent::hasAdjustmentsHtml();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAdjustmentsHtml');
        return $pluginInfo ? $this->___callPlugins('getAdjustmentsHtml', func_get_args(), $pluginInfo) : parent::getAdjustmentsHtml();
    }
